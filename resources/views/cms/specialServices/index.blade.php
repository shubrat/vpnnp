    ...
    <div class="modal fade" id="staticBackdropCreateClientModal" data-bs-backdrop="static" data-bs-keyboard="true"
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                <form action="{{ route('cms.specialServices.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
    ...
    <script>
          function toggleIsStatus(id) {
                ...
                $.ajax({
                    type: "GET",
                    dataType: "json",
                    url: "{{ route('cms.specialServices.toggle.status') }}",
                    data: {
                       'id': id,
                    },
        ...
        $(document).ready(() => {
            ...
            $('#datatable').on('click', '#delete-btn', function(event) {
                ...
                let id = $(this).data('id');
                let url = "{{ route('cms.specialServices.delete', '') }}/" +id;
