                ...
                <div class="card-body">
                    ...
                    <div class="card-header">
                        <div class="d-flex flex-wrap align-items-center">
                            ...
                            <div class="ms-auto">
                                <div>
                                    <a  href="{{ route('cms.sliders.create') }}"  class="btn btn-primary btn-md waves-effect waves-light">
        ...
        <script>
            function toggleIsStatus(id) {
                    ...
                    $.ajax({
                        type: "GET",
                        dataType: "json",
                        url: "{{ route('cms.sliders.toggle.status') }}",
                        data: {
                        'id': id,
                        },
            ...
            $(document).ready(() => {
                ...
                $('#datatable').on('click', '#delete-btn', function(event) {
                    ...
                    let id = $(this).data('id');
                    let url = "{{ route('cms.slider.delete', '') }}/" +id;
