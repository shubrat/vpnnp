...
<body>
    ...
    <div class="banner-style-01">                   
        ...
        <div class="banner-slider">
            ...
            <div>
                <div class="banner__bg d-flex align-items-center" style="background: url('{{ $slider->getFirstMediaUrl('image', 'original') }}') no-repeat center center/cover">
                    <div class="container-fluid px-5">
                        <div class="banner-content">
                            <h2 class="title" data-animation-in="fadeInRight">{{ $slider->title }}</h2>
                            <h3 class="subtitle" data-animation-in="fadeInLeft">{{ $slider->description }}</h3>
