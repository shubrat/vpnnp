...
<head>
    ...
    <meta http-equiv="X-UA-Compatible" content="ie=edge">
    <title>VPN-Group Of Companies</title>
    <!-- favicon -->
    <link rel="icon" href="{{ asset('sites\assets\img\favicon.png') }}" sizes="20x20" type="image/png">
    <!-- Vendor Stylesheet -->
    <link rel="stylesheet" href="{{ asset('sites\assets\css\vendor.css') }}">
    <!-- Main Stylesheet -->
    <link rel="stylesheet" href="{{ asset('sites\assets\css\style.css') }}">
    <!-- responsive Stylesheet -->
    <link rel="stylesheet" href="{{ asset('sites\assets\css\responsive.css') }}">
...
<body>
    ...
    <div class="banner-style-01">                   
        ...
        <div class="banner-slider">
            ...
            <div>
                <div class="banner__bg d-flex align-items-center" style="background: url('{{ $slider->getFirstMediaUrl('image', 'thumb-sm') }}') no-repeat center center/cover">
            ...
            <div>
                <div class="banner__bg d-flex align-items-center" style="background: url('{{ asset('sites/assets/img/banner/11.png') }}') no-repeat center center/cover">
                    <div class="container-fluid px-5">
                        <div class="banner-content">
                            <h3 class="subtitle" data-animation-in="fadeInLeft">30% OFF</h3>
                            <h2 class="title" data-animation-in="fadeInRight">FAVOURITE CLOTHING</h2>
            ...
            <div class="row">
                <div class="col-lg-4">
                    <div class="collection-style-01 margin-top-20">
                        <div class="thumb">
                            <img src="{{ asset('sites\assets\img\collection\1.png') }}" alt="">
                            <div class="content">
                                <h3>WOMEN</h3>
                                <h6>Collection</h6>
                ...
                <div class="col-lg-4">
                    <div class="collection-style-01 margin-top-20">
                        <div class="thumb">
                            <img src="{{ asset('sites\assets\img\collection\2.png') }}" alt="">
                            <div class="content">
                                <h3>MEN</h3>
                                <h6>Collection</h6>
                                <a href="#">view collection</a>
                ...
                <div class="col-lg-4">
                    <div class="collection-style-01 margin-top-20">
                        <div class="thumb">
                            <img src="{{ asset('sites\assets\img\collection\3.png') }}" alt="">
                            <div class="content">
                                <h3>KIDS</h3>
                                <h6>Collection</h6>
                                <a href="#">view collection</a>
            ...
            <div class="row">
                    ...
                    <div class="product-style-01 margin-top-40">
                        <div class="thumb">
                            <div class="thumb-slider">
                                <a href="single-product.html"><img src="{{ asset('sites\assets\img\arrival\1.png') }}" alt=""></a>
                                <a href="single-product.html"><img src="{{ asset('sites\assets\img\arrival\1.png') }}" alt=""></a>
                            </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                    <div class="product-style-01 margin-top-40">
                        <div class="thumb">
                            <div class="thumb-slider">
                                <a href="single-product.html"><img src="{{ asset('sites\assets\img\arrival\2.png') }}" alt=""></a>
                                <a href="single-product.html"><img src="{{ asset('sites\assets\img\arrival\2.png') }}" alt=""></a>
                            </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                    <div class="product-style-01 margin-top-40">
                        <div class="thumb">
                            <div class="thumb-slider">
                                <a href="single-product.html"><img src="{{ asset('sites\assets\img\arrival\3.png') }}" alt=""></a>
                                <a href="single-product.html"><img src="{{ asset('sites\assets\img\arrival\3.png') }}" alt=""></a>
                            </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                    <div class="product-style-01 margin-top-40">
                        <div class="thumb">
                            <div class="thumb-slider">
                                <a href="single-product.html"><img src="{{ asset('sites\assets\img\arrival\4.png')}}" alt=""></a>
                                <a href="single-product.html"><img src="{{ asset('sites\assets\img\arrival\4.png')}}" alt=""></a>
                            </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                    <div class="product-style-01 margin-top-40">
                        <div class="thumb">
                            <div class="thumb-slider">
                                <a href="single-product.html"><img src="{{ asset('sites\assets\img\arrival\5.png') }}" alt=""></a>
                                <a href="single-product.html"><img src="{{ asset('sites\assets\img\arrival\5.png') }}" alt=""></a>
                            </div>
                            <ul class="cart-action">
                                <li><a href="#"><i class="icon-add-to-cat"></i></a></li>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                    <div class="product-style-01 margin-top-40">
                        <div class="thumb">
                            <div class="thumb-slider">
                                <a href="single-product.html"><img src="{{ asset('sites\assets\img\arrival\6.png') }}" alt=""></a>
                                <a href="single-product.html"><img src="{{ asset('sites\assets\img\arrival\6.png') }}" alt=""></a>
                            </div>
                            <ul class="cart-action">
                                <li><a href="#"><i class="icon-add-to-cat"></i></a></li>
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                            <div class="product-style-02 margin-top-40">
                                <div class="thumb">
                                    <img src="{{ asset('sites\assets\img\tranding\1.png') }}" alt="">
                                    <span class="out">SOLD OUT</span>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                            <div class="product-style-02 margin-top-40">
                                <div class="thumb">
                                    <img src="{{ asset('sites\assets\img\tranding\2.png') }}" alt="">
                                    <span class="sale">SALE 13%</span>
                                    <ul class="cart-action-02">
                                        <li><a href="#"><i class="icon-heart"></i></a></li>
                                        <li><a href="#"><i class="icon-quick-view"></i></a></li>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                            <div class="product-style-02 margin-top-40">
                                <div class="thumb">
                                    <img src="{{ asset('sites\assets\img\tranding\3.png') }}" alt="">
                                    <span class="sale">SALE 13%</span>
                                    <span class="new margin-top-35">NEW</span>
                                    <ul class="cart-action-02">
                                        <li><a href="#"><i class="icon-heart"></i></a></li>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                            <div class="product-style-02 margin-top-40">
                                <div class="thumb">
                                    <img src="{{ asset('sites\assets\img\tranding\4.png') }}" alt="">
                                    <ul class="cart-action-02">
                                        <li><a href="#"><i class="icon-heart"></i></a></li>
                                        <li><a href="#"><i class="icon-quick-view"></i></a></li>
                                    </ul>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                            <div class="product-style-02 margin-top-40">
                                <div class="thumb">
                                    <img src="{{ asset('sites\assets\img\tranding\5.png') }}" alt="">
                                    <span class="new">NEW</span>
                                    <ul class="cart-action-02">
                                        <li><a href="#"><i class="icon-heart"></i></a></li>
                                        <li><a href="#"><i class="icon-quick-view"></i></a></li>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                            <div class="product-style-02 margin-top-40">
                                <div class="thumb">
                                    <img src="{{ asset('sites\assets\img\tranding\6.png') }}" alt="">
                                    <span class="sale">SALE! 13%</span>
                                    <ul class="cart-action-02">
                                        <li><a href="#"><i class="icon-heart"></i></a></li>
                                        <li><a href="#"><i class="icon-quick-view"></i></a></li>
                ...
                <div class="col-md-12">
                    <div class="collection-slider">
                        <div class="collection-item">
                            <div class="thumb">
                                <img src="{{ asset('sites\assets\img\collection\4.png') }}" alt="">
                        ...
                        <div class="collection-item">
                            <div class="thumb">
                                <img src="{{ asset('sites\assets\img\collection\5.png') }}" alt="">
                                <div class="thumb-content">
                                    <h2>ACCESSORIES</h2>
                                    <div class="btn-wrapper">
                                        <a href="#" class="btn btn-white">SHOP NOW <i class="icon-arrow-buttom"></i></a>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                    <div class="article-style-01">
                        <div class="thumb">
                            <img src="{{ asset('sites\assets\img\blog\1.png') }}" alt="">
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                    <div class="article-style-01">
                        <div class="thumb">
                            <img src="{{ asset('sites\assets\img\blog\2.png') }}" alt="">
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                    <div class="article-style-01">
                        <div class="thumb">
                            <img src="{{ asset('sites\assets\img\blog\3.png') }}" alt="">
                ...
                <div class="col-lg-12">
                    <div class="brand-slider">
                        <div class="brant-item">
                            <img src="{{ asset('sites\assets\img\brand\brand1.png') }}" alt="brand">
                        </div>
                        <div class="brant-item">
                            <img src="{{ asset('sites\assets\img\brand\brand2.png') }}" alt="brand">
                        </div>
                        <div class="brant-item">
                            <img src="{{ asset('sites\assets\img\brand\brand3.png') }}" alt="brand">
                        </div>
                        <div class="brant-item">
                            <img src="{{ asset('sites\assets\img\brand\brand4.png') }}" alt="brand">
                        </div>
                        <div class="brant-item">
                            <img src="{{ asset('sites\assets\img\brand\brand5.png') }}" alt="brand">
                        </div>
                        <div class="brant-item">
                            <img src="{{ asset('sites\assets\img\brand\brand6.png') }}" alt="brand">
                        </div>
                        <div class="brant-item">
                            <img src="{{ asset('sites\assets\img\brand\brand1.png') }}" alt="brand">
                        </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="instagram-slider">
                        <div class="thumb">
                            <img src="{{ asset('sites\assets\img\instagram\1.png') }}" alt="">
                        </div>
                        <div class="thumb">
                            <img src="{{ asset('sites\assets\img\instagram\2.png') }}" alt="">
                        </div>
                        <div class="thumb">
                            <img src="{{ asset('sites\assets\img\instagram\3.png') }}" alt="">
                        </div>
                        <div class="thumb">
                            <img src="{{ asset('sites\assets\img\instagram\4.png') }}" alt="">
                        </div>
                        <div class="thumb">
                            <img src="{{ asset('sites\assets\img\instagram\5.png') }}" alt="">
                        </div>
                        <div class="thumb">
                            <img src="{{ asset('sites\assets\img\instagram\6.png') }}" alt="">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-6 align-self-center">
                        <p>© vpn 2020. Powered with <i class="fa fa-heart"></i> by <a href="http://zwin.io/" target="_blanc">Zwin</a>.</p>
                    </div>
                    <div class="col-md-6">
                        <ul>
                            <li><a href="#"><img src="{{ asset('sites\assets\img\payment\1.png') }}" alt=""></a></li>
                            <li><a href="#"><img src="{{ asset('sites\assets\img\payment\2.png') }}" alt=""></a></li>
                            <li><a href="#"><img src="{{ asset('sites\assets\img\payment\3.png') }}" alt=""></a></li>
                            <li><a href="#"><img src="{{ asset('sites\assets\img\payment\4.png') }}" alt=""></a></li>
                            <li><a href="#"><img src="{{ asset('sites\assets\img\payment\5.png') }}" alt=""></a></li>
                            <li><a href="#"><img src="{{ asset('sites\assets\img\payment\6.png') }}" alt=""></a></li>
                        </ul>
                    </div>
                </div>
            </div>
    ...
    <!-- all plugins here -->
    <script src="{{ asset('sites\assets\js\vendor.js') }}"></script>
    <!-- main js  -->
